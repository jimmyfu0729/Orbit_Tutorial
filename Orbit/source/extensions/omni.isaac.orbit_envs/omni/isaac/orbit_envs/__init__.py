...
gym.register(
    id="Isaac-Ant-Tracing-v0",
    entry_point="omni.isaac.orbit_envs.classic.ant_v2:Ant2Env",
    kwargs={"cfg_entry_point": "omni.isaac.orbit_envs.classic.ant_v2:ant2_cfg.yaml"},
)
...
gym.register(
    id="Isaac-Pepper-Tracing-v0",
    entry_point="omni.isaac.orbit_envs.locomotion.pepper:PepperEnv",
    kwargs={"cfg_entry_point": "omni.isaac.orbit_envs.locomotion.pepper:PepperEnvCfg"},
)
