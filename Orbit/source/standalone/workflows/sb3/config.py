...
SB3_PPO_CONFIG_FILE = {
    ...
    "Isaac-Ant-Tracing-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/ant_ppo.yaml"),
    ...
    #locomotion
    "Isaac-Velocity-Anymal-C-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/pepper_ppo.yaml"),
    "Isaac-Pepper-Tracing-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/pepper_ppo.yaml"),
}
